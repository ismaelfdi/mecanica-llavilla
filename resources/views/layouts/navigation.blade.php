<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo.png') }}" alt="Mecánica Llavilla" class="block h-9 w-auto" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- INICIO: NUESTROS ENLACES DEL MENÚ -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- INICIO: NUESTROS ENLACES RESPONSIVE -->
            ...
            <x-responsive-nav-link :href="route('ordenes-trabajo.index')" :active="request()->routeIs('ordenes-trabajo.*')">
                {{ __('Órdenes de Trabajo') }}
            </x-responsive-nav-link>
            {{-- NUEVO ENLACE RESPONSIVE --}}
            <x-responsive-nav-link :href="route('items.index')" :active="request()->routeIs('items.*')">
                {{ __('Catálogo de Ítems') }}
            </x-responsive-nav-link>
            <!-- FIN: NUESTROS ENLACES RESPONSIVE -->
        </div>
