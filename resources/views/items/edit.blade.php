<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Editando Ítem: {{ $item->descripcion }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('items.update', $item) }}">
                        ...
                        <div>
                            ...
                            <select id="tipo" name="tipo" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                <option value="part" @selected(old('tipo', $item->tipo) == 'part')>Repuesto</option>
                                <option value="labor" @selected(old('tipo', $item->tipo) == 'labor')>Mano de Obra</option>
                            </select>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="descripcion" class="block mt-1 w-full" type="text" name="descripcion" :value="old('descripcion', $item->descripcion)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="codigo" class="block mt-1 w-full" type="text" name="codigo" :value="old('codigo', $item->codigo)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="precio_unitario" class="block mt-1 w-full" type="number" name="precio_unitario" :value="old('precio_unitario', $item->precio_unitario)" required step="0.01" />
